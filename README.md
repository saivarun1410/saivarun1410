...
| **[Agent Usage Menu](https://github.com/saivarun1410/agent-usage-menu)** | Keeps Codex and Claude Code rate limits in one tabbed macOS menu-bar popover—use either provider or both—with automatic refreshes, reset times, and local-only data handling. | Swift · SwiftUI · macOS · Codex CLI · Claude Code |
