...
| **[Agent Usage Menu](https://github.com/saivarun1410/agent-usage-menu)** | Keeps Codex and Claude Code rate limits in one tabbed macOS menu-bar popover—use either provider or both—with automatic refreshes, reset times, and local-only data handling. [Available on npm](https://www.npmjs.com/package/agent-usage-menu). | Swift · SwiftUI · macOS · Codex CLI · Claude Code |
| **[RealSecurePdf](https://github.com/saivarun1410/SecurePdf)** | Rearranges and merges PDFs entirely in the browser, then independently verifies the output before download. [Live app](https://real-secure-pdf.saivarun1410.workers.dev/) | TypeScript · PDF.js · Cloudflare. 
