...
| **[Codex & Claude Usage Menu](https://github.com/saivarun1410/codex-usage-menu)** | Keeps signed-in Codex and Claude Code usage visible in the macOS menu bar, with automatic refreshes, reset times, and a local-first design. | Swift · SwiftUI · macOS · Codex CLI · Claude Code |
