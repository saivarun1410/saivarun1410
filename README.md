...
| **[Agent Usage Menu](https://github.com/saivarun1410/agent-usage-menu)** | Keeps Codex and Claude Code rate limits visible in the macOS menu bar—use either provider or both—with automatic refreshes, reset times, and local-only data handling. | Swift · SwiftUI · macOS · Codex CLI · Claude Code |
